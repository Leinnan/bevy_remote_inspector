...
pub fn make_request<T: Serialize>(value: T, method: impl ToString, url: impl ToString) -> ehttp::Request {
...
pub fn parse<T>(response: &Response) -> Result<T,String> where T: DeserializeOwned {
